 ...
 */
final class Version20220301130857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE joueur ADD picture VARCHAR(255) NOT NULL');
    }
