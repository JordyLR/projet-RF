 ...
 */
final class Version20220302074239 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipe ADD banner VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipe DROP banner, CHANGE game game VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
